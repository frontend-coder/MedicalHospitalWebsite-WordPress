...
$(document).ready(function() {
	...
	$('#toggle').click(function () { $(this).toggleClass('active'); $('#overlay').toggleClass('open'); return false; 	});
...
$(function() {
 ...
 $('.command_title').equalHeights(); $('.command_prof').equalHeights();
// всплывающие окна обратной связи позвонить мне
$("a[href='#call-backtimer']").magnificPopup ({ mainClass:'mfp-fade', removalDelay:400, type:'inline' });
