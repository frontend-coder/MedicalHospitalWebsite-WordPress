    ...
    'contextual_help' => array(
      'content'       => array(
        array(
          ...
          'title'     => __( 'О теме', 'theme-text-domain' ),
          'content'   => '<p>' . __( 'Шаблон Wordpress создан под ключ на основе вручную сверстаного
HTML5 Medical Hospital tamplate Олегом Василенко!<br/> Контактная информация<br/>
Facebook - https://www.facebook.com/frontendercode<br/>
Instagram - https://www.instagram.com/frontendercode/<br/>
Githab - https://github.com/frontend-coder<br/>
Wire - @frontendcoder<br/>
Discort - https://discord.gg/wrqjEtr<br/>
Skype - webrabcom<br/> Telegram - https://t.me/frontendcoder<br/>
Slack https://frontendercode.slack.com/', 'theme-text-domain' ) . '</p>'
        )
      ),
      'sidebar'       => '<p>' . __( 'Оказываю помощь в разработке и производстве тем Wordpress под ключ.', 'theme-text-domain' ) . '</p>'
    ),
    ...
    'sections'        => array(
     array(
        'id'          => 'header_site',
        'title'       => __( 'Шапка сайта', 'theme-text-domain' )
      ),
          array(
        'id'          => 'footer_site',
        'title'       => __( 'Подвал сайта', 'theme-text-domain' )
      ),
      array(
        'id'          => 'option_types',
    ...
    'settings'        => array(
      ...
      array(
        'id'          => 'header_tab',
        'label'       => __( 'Основные', 'theme-text-domain' ),
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'header_site',
       ),
      array(
        'id'          => 'logo_upload',
        'label'       => __( 'Загрузить логотип в шапку сайта', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'С помощью этого поля Вы можете загрузить на сайт изображение для логотипа сайта в шапке сайта. Размеры загружаемого файла не должны превышать 210px x 42px. Перед загрузкой рекомендуется их оптимизировать с помощью сервиса https://www.iloveimg.com/ru/compress-image', 'theme-text-domain' ), apply_filters( 'ot_upload_text', __( 'Send to OptionTree', 'theme-text-domain' ) ), 'FTP' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'header_site',
        'rows'        => '',
      ...
      array(
        'id'          => 'favicon_upload',
        'label'       => __( 'Загрузить иконку фавикон для сайта', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'Загрузите и активируйте специальную иконку favicon для сайта. Сгенерируйте файл в формате ico c помощью этого сервиса https://www.favicon-generator.org/', 'theme-text-domain' ), apply_filters( 'ot_upload_text', __( 'Send to OptionTree', 'theme-text-domain' ) ), 'FTP' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'header_site',
        'rows'        => '',
     ...
     array(
        'id'          => 'header_tab1',
        'label'       => __( 'Информационный блок в шапке сайта', 'theme-text-domain' ),
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'header_site',
       ),
      array(
        'id'          => 'header_timework',
        'label'       => __( 'Время работы', 'theme-text-domain' ),
        'desc'        => __( 'Укажите время работы в рабочие дни недели исключая выходные и празничные дни, пример: 09:00 - 17:00.', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_site',
       ),
   array(
        'id'          => 'header_timerest',
        'label'       => __( 'Выходные дни', 'theme-text-domain' ),
        'desc'        => __( 'Укажите перечислите названия выходных дней, за исключением календарных праздничных государственных праздников. пример: суббота и воскресение', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_site',
       ),
  ...
  array(
        'id'          => 'header_email',
        'label'       => __( 'Контактный e-mail для клиентов', 'theme-text-domain' ),
        'desc'        => __( 'Укажите контактный e-mail для клиентов, на который вы желаете получать письма от потенциальных клиентов. Указанный e-mail должен отличаться от админского e-mail', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_site',
       ),
  ...
  array(
        'id'          => 'header_phone',
        'label'       => __( 'Контактный телефон', 'theme-text-domain' ),
        'desc'        => __( 'Введите номер контантного телефона, который будет отображаться в области верхнего меню на всех страницах сайта. Пример, +7 (425) 252-25-25 ', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_site',
       ),
     array(
        'id'          => 'header_tab2',
        'label'       => __( 'Социальные сети', 'theme-text-domain' ),
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'header_site',
       ),
// Facebook
         array(
        'id'          => 'facebook_visible_one_on_off',
        'label'       => __( 'Настроить ссылки на ваш аккаунт Facebook', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'C помощью этой вкладки вы можете настроить отображение, изменить ссылку на ваш аккаунт в Facebook.', 'theme-text-domain' ), '<code>on</code>', '<code>off</code>' ),
        'std'         => 'off',
        'type'        => 'on-off',
        'section'     => 'header_site'
      ),
    ...
    array(
        'id'          => 'dell_facebook_on_off',
        'label'       => __( 'Отображать/Скрыть ссылку Facebook', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'C помощью этого переключателя вы можете включить/отключить отображение ссылки на Facebook на всех страницах сайта без исключения. Сохраните положение переключателя в позиции включено или выключено.', 'theme-text-domain' ), '<code>on</code>', '<code>off</code>' ),
        'std'         => 'on',
        'type'        => 'on-off',
        'section'     => 'header_site',
        'condition'   => 'facebook_visible_one_on_off:is(on)'
     ),
 array(
        'id'          => 'header_facebook',
        'label'       => __( 'Ccылка на аккаунт Facebook', 'theme-text-domain' ),
        'desc'        => __( 'Введите адрес вашего аккаунта/страницы на Facebook', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_site',
        'condition'   => 'facebook_visible_one_on_off:is(on)'
...
/*Google+ */
        array(
        'id'          => 'google_visible_one_on_off',
        'label'       => __( 'Настроить ссылки на ваш аккаунт Google+', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'C помощью этой вкладки вы можете настроить отображение, изменить ссылку на ваш аккаунт в Google+.', 'theme-text-domain' ), '<code>on</code>', '<code>off</code>' ),
        'std'         => 'off',
        'type'        => 'on-off',
        'section'     => 'header_site'
      ),
    ...
    array(
        'id'          => 'dell_google_on_off',
        'label'       => __( 'Отображать/Скрыть ссылку Google', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'C помощью этого переключателя вы можете включить/отключить отображение ссылки на Google+ на всех страницах сайта без исключения. Сохраните положение переключателя в позиции включено или выключено.', 'theme-text-domain' ), '<code>on</code>', '<code>off</code>' ),
        'std'         => 'on',
        'type'        => 'on-off',
        'section'     => 'header_site',
        'condition'   => 'google_visible_one_on_off:is(on)'
     ),
 array(
        'id'          => 'header_google',
        'label'       => __( 'Ccылка на аккаунт Google+', 'theme-text-domain' ),
        'desc'        => __( 'Введите адрес вашего аккаунта/страницы на Google+', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_site',
        'condition'   => 'google_visible_one_on_off:is(on)'
...
/*вКОНТАКТЕ */
        ...
        array(
        'id'          => 'vk_visible_one_on_off',
        'label'       => __( 'Настроить ссылки на ваш аккаунт Ввконтакте', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'C помощью этой вкладки вы можете настроить отображение, изменить ссылку на ваш аккаунт в Ввконтакте.', 'theme-text-domain' ), '<code>on</code>', '<code>off</code>' ),
        'std'         => 'off',
        'type'        => 'on-off',
        'section'     => 'header_site'
      ),
    ...
    array(
        'id'          => 'dell_vk_on_off',
        'label'       => __( 'Отображать/Скрыть ссылку Ввконтакте', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'C помощью этого переключателя вы можете включить/отключить отображение ссылки на Ввконтакте на всех страницах сайта без исключения. Сохраните положение переключателя в позиции включено или выключено.', 'theme-text-domain' ), '<code>on</code>', '<code>off</code>' ),
        'std'         => 'on',
        'type'        => 'on-off',
        'section'     => 'header_site',
        'condition'   => 'vk_visible_one_on_off:is(on)'
     ),
  array(
        'id'          => 'header_vk',
        'label'       => __( 'Ccылка на аккаунт Ввконтакте', 'theme-text-domain' ),
        'desc'        => __( 'Введите адрес вашего аккаунта/страницы на Ввконтакте', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_site',
       'condition'   => 'vk_visible_one_on_off:is(on)'
...
/*Youtube */
        array(
        'id'          => 'youtube_visible_one_on_off',
        'label'       => __( 'Настроить ссылки на ваш аккаунт Youtube', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'C помощью этой вкладки вы можете настроить отображение, изменить ссылку на ваш аккаунт в Youtube.', 'theme-text-domain' ), '<code>on</code>', '<code>off</code>' ),
        'std'         => 'off',
        'type'        => 'on-off',
        'section'     => 'header_site'
      ),
    ...
    array(
        'id'          => 'dell_youtube_on_off',
        'label'       => __( 'Отображать/Скрыть ссылку Youtube', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'C помощью этого переключателя вы можете включить/отключить отображение ссылки на Youtube на всех страницах сайта без исключения. Сохраните положение переключателя в позиции включено или выключено.', 'theme-text-domain' ), '<code>on</code>', '<code>off</code>' ),
        'std'         => 'on',
        'type'        => 'on-off',
        'section'     => 'header_site',
        'condition'   => 'youtube_visible_one_on_off:is(on)'
     ),
array(
        'id'          => 'header_youtube',
        'label'       => __( 'Ccылка на аккаунт Youtube', 'theme-text-domain' ),
        'desc'        => __( 'Введите адрес вашего аккаунта/страницы на Youtube', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_site',
        'condition'   => 'youtube_visible_one_on_off:is(on)'
...
/*Linkedin */
   array(
        'id'          => 'linkedin_visible_one_on_off',
        'label'       => __( 'Настроить ссылки на ваш аккаунт Linkedin', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'C помощью этой вкладки вы можете настроить отображение, изменить ссылку на ваш аккаунт в Linkedin.', 'theme-text-domain' ), '<code>on</code>', '<code>off</code>' ),
        'std'         => 'off',
        'type'        => 'on-off',
        'section'     => 'header_site'
      ),
    ...
    array(
        'id'          => 'dell_linkedin_on_off',
        'label'       => __( 'Отображать/Скрыть ссылку Linkedin', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'C помощью этого переключателя вы можете включить/отключить отображение ссылки на Linkedin на всех страницах сайта без исключения. Сохраните положение переключателя в позиции включено или выключено.', 'theme-text-domain' ), '<code>on</code>', '<code>off</code>' ),
        'std'         => 'on',
        'type'        => 'on-off',
        'section'     => 'header_site',
        'condition'   => 'linkedin_visible_one_on_off:is(on)'
     ),

array(
        'id'          => 'header_linkedin',
        'label'       => __( 'Ccылка на аккаунт Linkedin', 'theme-text-domain' ),
        'desc'        => __( 'Введите адрес вашего аккаунта/страницы на Linkedin', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_site',
        'condition'   => 'linkedin_visible_one_on_off:is(on)'
...
array(
        'id'          => 'footer_email_one',
        'label'       => __( 'Первый E-mail в подвале', 'theme-text-domain' ),
        'desc'        => __( 'Введите первый E-mail для клиентов, он будет отображаться в подвале сайта на всех страницах сайта', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
       'section'     => 'footer_site',
      ),
...
array(
        'id'          => 'footer_email_two',
        'label'       => __( 'Второй E-mail в подвале', 'theme-text-domain' ),
        'desc'        => __( 'Введите второй E-mail для клиентов, он будет отображаться в подвале сайта на всех страницах сайта', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
       'section'     => 'footer_site',
      ),
...
array(
        'id'          => 'footer_phone_one',
        'label'       => __( 'Первый номер телефона в подвале', 'theme-text-domain' ),
        'desc'        => __( 'Введите первый номер контантного телефона, который будет отображаться в области верхнего меню на всех страницах сайта. Пример, +7 (425) 252-25-25 ', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
       'section'     => 'footer_site',
      ),
...
array(
        'id'          => 'footer_phone_two',
        'label'       => __( 'Второй номер телефона в подвале', 'theme-text-domain' ),
        'desc'        => __( 'Введите второй номер контантного телефона, который будет отображаться в области верхнего меню на всех страницах сайта. Пример, +7 (425) 252-25-25 ', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
       'section'     => 'footer_site',
      ),
    ...
    array(
        'id'          => 'footer_locate_text',
        'label'       => __( 'Укажите адрес основного офиса', 'theme-text-domain' ),
        'desc'        => __( 'Укажите адрес основного офиса, он будет отображаться на всех страницах сайта в его подвале.', 'theme-text-domain' ),
        'std'         => '',
...
// КОНЕЦ ОПЦИЙ НАСТРОЕК
      ...
      array(
        ...
        'desc'        => __( 'бордюра Border option type is used to set width, unit, style, and color values.', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'border',
        'section'     => 'option_types',
        'rows'        => '',
